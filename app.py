...
image = Image.open(r"D:\TEXTS\_bg_.jpg")
photo = ImageTk.PhotoImage(image)
lab = Label(image=photo, bg='#8fb5c2')
lab.pack()

# Defining the Labels
message = Label(window, text="Image-Text-Speech Converter", bg="#000000", fg="#FFFF00", width=200, height=3,
                font=('Helvetica', 35, 'italic bold '))
message.place(x=60, y=10)
message = Label(window,
                text="Note : Text field in only for 'Text-to-Audio' file\n RIGHT CLICK to paste the text copied from 'Pic-to-Text' file",
                bg="#000000", fg="#FF0000", width=70, height=8, font=('Helvetica', 15, 'italic bold '))
message.place(x=130, y=120)
lbl2 = Label(window, text="Enter text :", width=20, fg="white", bg="#000000", height=2,
...
def PicTexts():
    ...
    pytesseract.pytesseract.tesseract_cmd = "D:\\software\\tesseract.exe"
...
pictext = Button(window, text="Pic-to-Text", command=PicTexts, fg="red", bg="white", width=20, height=3,
                 activebackground="grey", font=('Helvetica', 15, ' bold '))
pictext.place(x=1000, y=170)
picspeech = Button(window, text="Pic-to-Audio", command=picSpeechs, fg="red", bg="white", width=20, height=3,
                   activebackground="grey", font=('Helvetica', 15, ' bold '))
picspeech.place(x=1000, y=270)
textspeech = Button(window, text="Text-to-Audio", command=TextSpeechs, fg="red", bg="white", width=20, height=3,
                    activebackground="grey", font=('Helvetica', 15, ' bold '))
textspeech.place(x=1000, y=370)
quitWindow = Button(window, text="Quit", command=window.destroy, fg="red", bg="white", width=17, height=2,
                    activebackground="grey", font=('Helvetica', 15, ' bold '))
